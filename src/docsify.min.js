! function() {
	...
	function R(e, t) {
		void 0 === t && (t = []);
		var n, r = [];
		for (n in e) - 1 < t.indexOf(n) || r.push(e[n] ? (T(n) + "=" + T(e[n]))
			.toLowerCase() : T(n));
	...
	I.prototype.getBasePath = function() {
		...
		return e = i.alias ? function e(t, n, r) {
			var i = Object.keys(n)
				.filter(function(e) {
					return (P[e] || (P[e] = new RegExp("^" + e + "$")))
						.test(t) && t !== r
				})[0];
			return i ? e(t.replace(P[i], n[i]), n, t) : t
		}(e, i.alias) : e, n = e, r = a, e = (e = new RegExp("\\.(" + r.replace(/^\./, "") + "|html)$", "g")
			.test(n) ? n : /\/$/g.test(n) ? n + "README" + r : "" + n + r) === "/README" + a && i.homepage || e, e = O(e) ? e : N(o, e), t && (e = e.replace(new RegExp("^" + o), "")), e
	}, I.prototype.onchange = function(e) {
		void 0 === e && (e = u), e()
	}, I.prototype.getCurrentPath = function() {}, I.prototype.normalize = function() {}, I.prototype.parse = function() {}, I.prototype.toURL = function(e, t, n) {
		var r = n && "#" === e[0],
			i = this.parse(M(e));
		if (i.query = y({}, i.query, t), e = (e = i.path + R(i.query))
			.replace(/\.md(\?)|\.md$/, "$1"), r && (e = (0 < (r = n.indexOf("?")) ? n.substring(0, r) : n) + e), this.config.relativePath && 0 !== e.indexOf("/")) {
	...
	var H = function(r) {
			...
			return r && (e.__proto__ = r), ((e.prototype = Object.create(r && r.prototype))
					.constructor = e)
			...
			return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype))
				...
				.prototype.getCurrentPath = function() {
					...
					void 0 === n && (n = u), x("click", function(e) {
						...
						t && "A" === t.tagName && !/_blank/.test(t.target) && (e.preventDefault(), t = t.href, -1 !== r.config.crossOriginLinks.indexOf(t) ? window.open(t, "_self") : window.history.pushState({
							key: t
						}, "", t), n({
							event: e,
							source: "navigate"
	...
	var ie, oe, ae = function t(e) {
		...
		var l = s.document,
			...
			y = Be(i, "childNodes"),
			b = Be(i, "parentNode");
		"function" != typeof n || (n = o.createElement("template"))
			.content && n.content.ownerDocument && (o = n.content.ownerDocument);
		var k = ht(e, l),
			w = k && ee ? k.createHTML("") : "",
			x = o.implementation,
		...
		function Ee(e) {
			...
			}(e) || ("noscript" === n || "noembed" === n) && je(/<\/no(script|embed)/i, e.innerHTML) ? (we(e), 1) : (W && 3 === e.nodeType && (t = e.textContent, t = De(t, F, " "), t = De(t, C, " "), e.textContent !== t && (ze(c.removed, {
				element: e.cloneNode()
			}), e.textContent = t)), Te("afterSanitizeElements", e, null), 0);
			if (ne && !ie[n]) {
				var r = b(e) || e.parentNode,
					i = y(e) || e.childNodes;
				if (i && r)
					for (var o = i.length - 1; 0 <= o; --o) r.insertBefore(m(i[o], !0), v(e))
			}
			return we(e), 1
		}
			...
			if (r) {
				for (var i = {
					...
					var o = (l = r[n])
						...
						t = Ie(l.value),
						s = Ne(o);
					if (i.attrName = s, i.attrValue = t, i.keepAttr = !0, i.forceKeepAttr = void 0, Te("uponSanitizeAttribute", e, i), t = i.attrValue, !i.forceKeepAttr && (xe(o, e), i.keepAttr))
						if (je(/\/>/i, t)) xe(o, e);
						else {
							W && (t = De(t, F, " "), t = De(t, C, " "));
		...
		return c.sanitize = function(e, t) {
			...
			if (Y || O(t), c.removed = [], "string" == typeof e && (re = !1), !re)
				if (e instanceof p) 1 === (t = (r = _e("\x3c!----\x3e"))
						.ownerDocument.importNode(e, !0))
					.nodeType && "BODY" === t.nodeName || "HTML" === t.nodeName ? r = t : r.appendChild(t);
				else {
			...
			if (K) {
				if (Q)
					for (o = S.call(r.ownerDocument); r.firstChild;) o.appendChild(r.firstChild);
				else o = r;
	...
	function se(e) {
		var t, n = e.loaded,
			...
			i = e.step;
		ie || ((e = v("div"))
			.classList.add("progress"), a(g, e), ie = e), t = i ? 80 < (t = parseInt(ie.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), ie.style.opacity = 1, ie.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(oe), oe = setTimeout(function(e) {
	...
	function he() {
		...
		t && (e = t.getBoundingClientRect()
			.height, window.pageYOffset >= e || t.classList.contains("hidden") ? S(g, "add", "sticky") : S(g, "remove", "sticky"))
	}
	...
	function we(e) {
		var t, n = y({
			...
			r = ke || [].slice.call(document.getElementsByTagName("script"))
			.filter(function(e) {
	...
	function Oe(e, t) {
		var n, r;
		t && (r = we()
			.topMargin, (n = b("#" + t)) && (n = n, void 0 === (r = r) && (r = 0), Se && Se.stop(), Ae = !1, Se = new ye({
					start: window.pageYOffset,
					end: Math.round(n.getBoundingClientRect()
						.top) + window.pageYOffset - r,
					duration: 500
				})
				.on("tick", function(e) {
		...
		Nt = function(n, e) {
			...
			var r = {
				replace: function(e, t) {
					return t = (t = t.source || t)
						.replace(St, "$1"), n = n.replace(e, t), r
				},
				getRegex: function() {
			...
			return e.prototype.space = function(e) {
					...
					for (var t, n, r, i, o, a = e[0], s = e[2], l = 1 < s.length, c = {
						...
						if (a = t = u[f], f !== h - 1) {
							if (r = this.rules.block.listItemStart.exec(u[f + 1]), this.options.pedantic ? r[1].length > d[1].length : r[1].length > d[0].length || 3 < r[1].length) {
								u.splice(f, 2, u[f] + "\n" + u[f + 1]), f--, h--;
								continue
							}(!this.options.pedantic || this.options.smartLists ? r[2][r[2].length - 1] !== s[s.length - 1] : l == (1 === r[2].length)) && (n = u.slice(f + 1)
								.join("\n"), c.raw = c.raw.substring(0, c.raw.length - n.length), f = h - 1), d = r
						}
						r = t.length, ~(t = t.replace(/^ *([*+-]|\d+[.)]) ?/, ""))
				...
				if (t) {
					...
					if (!this.options.pedantic && /^</.test(n)) {
						...
						var r = Bt(t[2], "()"); - 1 < r && (o = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r, t[2] = t[2].substring(0, r), t[0] = t[0].substring(0, o)
							.trim(), t[3] = "")
					}
					var i, r = t[2],
						o = "";
	...
	Nt.def = I(Nt.def)
		...
		.getRegex(), Nt.bullet = /(?:[*+-]|\d{1,9}[.)])/, Nt.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/, Nt.item = I(Nt.item, "gm")
		.replace(/bull/g, Nt.bullet)
		.getRegex(), Nt.listItemStart = I(/^( *)(bull)/)
		.replace("bull", Nt.bullet)
		.getRegex(), Nt.list = I(Nt.list)
		.replace(/bull/g, Nt.bullet)
		.replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))")
		.replace("def", "\\n+(?=" + Nt.def.source + ")")
		.getRegex(), Nt._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", Nt._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/, Nt.html = I(Nt.html, "i")
		.replace("comment", Nt._comment)
		.replace("tag", Nt._tag)
		.replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/)
		.getRegex(), Nt.paragraph = I(Nt._paragraph)
		.replace("hr", Nt.hr)
		...
		.replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)")
		.replace("tag", Nt._tag)
		.getRegex(), Nt.blockquote = I(Nt.blockquote)
		.replace("paragraph", Nt.paragraph)
		.getRegex(), Nt.normal = Dt({}, Nt), Nt.gfm = Dt({}, Nt.normal, {
		...
		.replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)")
		.replace("tag", Nt._tag)
		.getRegex(), Nt.gfm.table = I(Nt.gfm.table)
		.replace("hr", Nt.hr)
		.replace("heading", " {0,3}#{1,6} ")
		.replace("blockquote", " {0,3}>")
		.replace("code", " {4}[^\\n]")
		...
		.replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)")
		.replace("tag", Nt._tag)
		.getRegex(), Nt.pedantic = Dt({}, Nt.normal, {
			html: I("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))")
				.replace("comment", Nt._comment)
	...
	It.punctuation = I(It.punctuation)
		...
		.getRegex(), It._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>", It._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*", It._comment = I(Nt._comment)
		.replace("(?:--\x3e|$)", "--\x3e")
		.getRegex(), It.em.start = I(It.em.start)
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.em.middle = I(It.em.middle)
		.replace(/punctuation/g, It._punctuation)
		.replace(/overlapSkip/g, It._overlapSkip)
		.getRegex(), It.em.endAst = I(It.em.endAst, "g")
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.em.endUnd = I(It.em.endUnd, "g")
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.strong.start = I(It.strong.start)
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.strong.middle = I(It.strong.middle)
		.replace(/punctuation/g, It._punctuation)
		.replace(/overlapSkip/g, It._overlapSkip)
		.getRegex(), It.strong.endAst = I(It.strong.endAst, "g")
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.strong.endUnd = I(It.strong.endUnd, "g")
		.replace(/punctuation/g, It._punctuation)
		.getRegex(), It.blockSkip = I(It._blockSkip, "g")
		.getRegex(), It.overlapSkip = I(It._overlapSkip, "g")
		.getRegex(), It._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, It._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, It._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, It.autolink = I(It.autolink)
		.replace("scheme", It._scheme)
		.replace("email", It._email)
		.getRegex(), It._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, It.tag = I(It.tag)
		.replace("comment", It._comment)
		.replace("attribute", It._attribute)
		.getRegex(), It._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, It._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/, It._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, It.link = I(It.link)
		.replace("label", It._label)
		.replace("href", It._href)
		.replace("title", It._title)
		.getRegex(), It.reflink = I(It.reflink)
		.replace("label", It._label)
		.getRegex(), It.reflinkSearch = I(It.reflinkSearch, "g")
		.replace("reflink", It.reflink)
		.replace("nolink", It.nolink)
		.getRegex(), It.normal = Dt({}, It), It.pedantic = Dt({}, It.normal, {
			strong: {
				start: /^__|\*\*/,
	...
	var Jt = function() {
			...
			return e.rules.get = function() {
				...
				for (void 0 === t && (t = []), void 0 === n && (n = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e;)
					...
					else if (r = this.tokenizer.code(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : ((a = t[t.length - 1])
					.raw += "\n" + r.raw, a.text += "\n" + r.text);
				...
				else if (r = this.tokenizer.text(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : ((a = t[t.length - 1])
					.raw += "\n" + r.raw, a.text += "\n" + r.text);
				else if (e) {
				...
				for (var t, n, r, i, o, a = e.length, s = 0; s < a; s++) switch ((o = e[s])
					.type) {
					case "paragraph":
					case "text":
					case "heading":
				...
				if (this.tokens.links) {
					...
					if (0 < c.length)
						for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(l));) c.includes(o[0].slice(o[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, o.index) + "[" + Xt("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
				}
				...
				for (; e;)
					...
					if (i = this.tokenizer.inlineText(e, r, Kt)) e = e.substring(i.raw.length), s = i.raw.slice(-1), a = !0, t.push(i);
					else if (e) {
		...
		cn = function() {
			...
			return n.parse = function(e, t) {
				...
				void 0 === t && (t = !0);
				for (var n, r, i, o, a, s, l, c, u, p, h, d, f, g, m, v = "", y = e.length, b = 0; b < y; b++) switch ((c = e[b])
					.type) {
					case "space":
						continue;
					case "hr":
					...
					case "table":
						...
						for (u += this.renderer.tablerow(s), l = "", i = c.cells.length, n = 0; n < i; n++) {
							for (s = "", o = (a = c.tokens.cells[n])
								.length, r = 0; r < o; r++) s += this.renderer.tablecell(this.parseInline(a[r]), {
								header: !1,
								align: c.align[r]
							});
					...
					case "blockquote":
						...
						continue;
					case "list":
						for (u = c.ordered, k = c.start, p = c.loose, i = c.items.length, l = "", n = 0; n < i; n++) f = (d = c.items[n])
							.checked, g = d.task, h = "", d.task && (m = this.renderer.checkbox(f), p ? 0 < d.tokens.length && "text" === d.tokens[0].type ? (d.tokens[0].text = m + " " + d.tokens[0].text, d.tokens[0].tokens && 0 < d.tokens[0].tokens.length && "text" === d.tokens[0].tokens[0].type && (d.tokens[0].tokens[0].text = m + " " + d.tokens[0].tokens[0].text)) : d.tokens.unshift({
								type: "text",
								text: m
					...
					case "text":
						for (l = c.tokens ? this.parseInline(c.tokens) : c.text; b + 1 < y && "text" === e[b + 1].type;) l += "\n" + ((c = e[++b])
							.tokens ? this.parseInline(c.tokens) : c.text);
				...
				t = t || this.renderer;
				for (var n = "", r = e.length, i = 0; i < r; i++) switch ((o = e[i])
					.type) {
					case "escape":
						n += t.text(o.text);
						break;
	...
	function yn(e, r) {
		...
		return e.forEach(function(e) {
			var t = e.level || 1,
				n = t - 1;
			r < t || (o[n] ? o[n].children = (o[n].children || [])
				.concat(e) : i.push(e), o[t] = e)
		}), i
	}
	var bn = {},
		kn = /[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g;
	...
	var Tn, En = ft(function(e) {
		var a, s, l, c, u, r, t, i = function(l) {
			var c = /\blang(?:uage)?-([\w-]+)\b/i,
				...
				$ = {
					...
					util: {
						encode: function e(t) {
							return t instanceof F ? new F(t.type, e(t.content), t.alias) : Array.isArray(t) ? t.map(e) : t.replace(/&/g, "&amp;")
								.replace(/</g, "&lt;")
								.replace(/\u00a0/g, " ")
						},
						type: function(e) {
					...
					highlightElement: function(e, t, n) {
						...
						o && "pre" === o.nodeName.toLowerCase() && (o.className = o.className.replace(c, "")
							.replace(/\s+/g, " ") + " language-" + r);
						var a = {
							element: e,
							language: r,
						...
						$.hooks.run("before-highlight", a), a.grammar ? t && l.Worker ? ((t = new Worker($.filename))
									...
									if (r.hasOwnProperty(s) && r[s]) {
										...
										for (var c = 0; c < l.length; ++c) {
											...
											var u, p = l[c],
												...
												f = !!p.greedy,
												g = p.alias;
											f && !p.pattern.global && (u = p.pattern.toString()
												.match(/[imsuy]*$/)[0], p.pattern = RegExp(p.pattern.source, u + "g"));
			...
			function F(e, t, n, r) {
				this.type = e, this.content = t, this.alias = n, this.length = 0 | (r || "")
					.length
			}
			...
			if (l.Prism = $, F.stringify = function t(e, n) {
				...
				var o, a = "";
				for (o in i.attributes) a += " " + o + '="' + (i.attributes[o] || "")
					.replace(/"/g, "&quot;") + '"';
		...
		e.exports && (e.exports = i), void 0 !== dt && (dt.Prism = i), i.languages.markup = {
			...
			function(e) {
				...
				o.matches(u) && (e.code = "", o.setAttribute(l, c), (t = o.appendChild(document.createElement("CODE")))
					.textContent = "Loading…", n = o.getAttribute("data-src"), "none" === (e = e.language) && (r = (/\.(\w+)$/.exec(n) || [, "none"])[1], e = s[r] || r), p(t, e), p(o, e), (r = a.plugins.autoloader) && r.loadLanguages(e), (i = new XMLHttpRequest)
					.open("GET", n, !0), i.onreadystatechange = function() {
				...
				highlight: function(e) {
					for (var t, n = (e || document)
						.querySelectorAll(u), r = 0; t = n[r++];) a.highlightElement(t)
				}
		...
		this._marked = a, this.compile = function(n) {
			var r = !0,
				e = s(function(e) {
					r = !1;
					var t = "";
					return n ? (t = c(n) ? a(n) : a.parser(n), t = i.noEmoji ? t : t.replace(/:\+1:/g, ":thumbsup:")
						...
						.replace(/__colon__/g, ":"), xn.clear(), t) : n
				})(n),
				t = o.router.parse()
				.file;
	...
	On.prototype.compileEmbed = function(e, t) {
		var n, r, i = Sn(t),
			o = i.str,
			i = i.config;
		if (t = o, i.include) return O(e) || (e = N(this.contentBase, F(this.router.getCurrentPath()), e)), i.type && (r = Fn[i.type]) ? (n = r.call(this, e, t))
			.type = i.type : (r = "code", /\.(md|markdown)/.test(e) ? r = "markdown" : /\.mmd/.test(e) ? r = "mermaid" : /\.html?/.test(e) ? r = "iframe" : /\.(mp4|ogg)/.test(e) ? r = "video" : /\.mp3/.test(e) && (r = "audio"), (n = Fn[r].call(this, e, t))
				.type = r), n.fragment = i.fragment, n
	}, On.prototype._matchNotCompileLink = function(e) {
		for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
			var r = t[n];
			if (($n[r] || ($n[r] = new RegExp("^" + r + "$")))
				.test(e)) return e
		}
	}, On.prototype._initRenderer = function() {
		var a, s, l, c, u, p, e = new gn.Renderer,
			t = this.linkTarget,
			n = this.linkRel,
			o = this.router,
			r = this.contentBase,
		...
		return i.heading = e.heading = function(e, t) {
			...
			n = xn(i.id || r), i = o.toURL(o.getCurrentPath(), {
				id: n
			});
			...
			.renderer, a = t.router, s = t.linkTarget, l = t.linkRel, c = t.compilerClass, n.link = function(e, t, n) {
				...
				var r = [],
					...
					o = i.str,
					i = i.config;
				return s = i.target || s, l = "_blank" === s ? c.config.externalLinkRel || "noopener" : "", t = o, O(e) || c._matchNotCompileLink(e) || i.ignore ? (O(e) || "./" !== e.slice(0, 2) || (e = document.URL.replace(/\/(?!.*\/).*/, "/")
					.replace("#/./", "") + e), r.push(0 === e.indexOf("mailto:") ? "" : 'target="' + s + '"'), r.push(0 !== e.indexOf("mailto:") && "" !== l ? ' rel="' + l + '"' : "")) : (e === c.config.homepage && (e = "README"), e = a.toURL(e, null, a.getCurrentPath())), i.crossorgin && "_self" === s && "history" === c.config.routerMode && -1 === c.config.crossOriginLinks.indexOf(e) && c.config.crossOriginLinks.push(e), i.disabled && (r.push("disabled"), e = "javascript:void(0)"), i.class && r.push('class="' + i.class + '"'), i.id && r.push('id="' + i.id + '"'), t && r.push('title="' + t + '"'), '<a href="' + e + '" ' + r.join(" ") + ">" + n + "</a>"
			}), i.paragraph = {
			renderer: e
			...
			t = t ? "ol" : "ul";
			return "<" + t + " " + [/<li class="task-list-item">/.test(e.split('class="task-list"')[0]) ? 'class="task-list"' : "", n && 1 < n ? 'start="' + n + '"' : ""].join(" ")
				.trim() + ">" + e + "</" + t + ">"
		}, i.listitem = {
			renderer: e
		...
		! function(e, o) {
			...
			for (; t = n[s++];) {
				var r = function(i) {
					return function(e) {
						var t, n, r;
						e && ("markdown" === i.embed.type ? ((n = i.embed.url.split("/"))
								.pop(), n = n.join("/"), e = e.replace(/\[([^[\]]+)\]\(([^)]+)\)/g, function(e) {
									var t = e.indexOf("(");
									...
									.installed || !1) && (e = $docsify.frontMatter.parseMarkdown(e)), t = a.lexer(e)) : "code" === i.embed.type ? (i.embed.fragment && (r = i.embed.fragment, r = new RegExp("(?:###|\\/\\/\\/)\\s*\\[" + r + "\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[" + r + "\\]"), e = Ln((e.match(r) || [])[1] || "")
								.trim()), t = a.lexer("```" + i.embed.lang + "\n" + e.replace(/`/g, "@DOCSIFY_QM@") + "\n```\n")) : "mermaid" === i.embed.type ? (t = [{
								type: "html",
				...
				t.embed.url ? ce(t.embed.url)
					.then(r) : r(t.embed.html)
			}
		}({
			compile: n,
			embedTokens: s,
			...
			e ? (t = e.index, u.forEach(function(e) {
				...
				}), y(c, n.links), a = a.slice(0, t)
				.concat(n, a.slice(t + 1)), u.push({
					start: t,
					length: n.length - 1
	...
	function Mn(e, t, n) {
		var r, i, o, a;
		return t = "function" == typeof n ? n(t) : "string" == typeof n ? (o = [], a = 0, (r = n)
			.replace(B, function(t, e, n) {
				o.push(r.substring(a, n - 1)), a = n += t.length + 1, o.push(i && i[t] || function(e) {
					return ("00" + ("string" == typeof Z[t] ? e[Z[t]]() : Z[t](e)))
						.slice(-t.length)
				})
	...
	function Dn(e) {
		...
		if (e = e || "<h1>404 - Not found</h1>", "Vue" in window)
			for (var o = 0, a = k(".markdown-section > *")
				.filter(t); o < a.length; o += 1) {
				var s = a[o];
				2 === i ? s.__vue__.$destroy() : 3 === i && s.__vue_app__.unmount()
			}
		if (this._renderTo(r, e), n.loadSidebar || this._renderSidebar(), (n.executeScript || "Vue" in window && !1 !== n.executeScript) && (!(e = k(".markdown-section>script")
			.filter(function(e) {
			...
			2 === i && p.length && p.forEach(function(e) {
			...
			}), !Cn && n.vueGlobalOptions && "function" == typeof n.vueGlobalOptions.data && (Cn = n.vueGlobalOptions.data()), u.push.apply(u, Object.keys(n.vueMounts || {})
				.map(function(e) {
				...
				.filter(function(e) {
					...
					e[1];
					return t
				})), (n.vueGlobalOptions || p.length) && (l = /{{2}[^{}]*}{2}/, c = /<[^>/]+\s([@:]|v-)[\w-:.[\]]+[=>\s]/, u.push.apply(u, k(".markdown-section > *")
				.filter(function(n) {
			...
			for (var h = 0, d = u; h < d.length; h += 1) {
				var f, g = d[h],
					...
					v = g[1],
					g = "data-isvue";
				m.matches("pre, script") || t(m) || m.querySelector("[" + g + "]") || (m.setAttribute(g, ""), 2 === i ? (v.el = void 0, new window.Vue(v)
					.$mount(m)) : 3 === i && (f = window.Vue.createApp(v), p.forEach(function(e) {
	...
	function Pn(t, n, r, i, o, e) {
		t = e ? t : t.replace(/\/$/, ""), (t = F(t)) && ce(o.router.getFile(t + r) + n, !1, o.config.requestHeaders)
			.then(i, function(e) {
				return Pn(t, n, r, i, o)
			})
	}
	...
	var jn, Hn, qn = function(e) {
		...
		return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype))
				.constructor = t)
		...
		return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype))
				.constructor = t)
			.prototype._loadSideAndNav = function(e, t, n, r) {
				var i = this;
				return function() {
					if (!n) return r();
					Pn(e, t, n, function(e) {
				...
				var r = this;
				void 0 === n && (n = u);
				var i, e, t, o, a, s = this.route.query,
					l = this.route.path;
				p(l) ? (history.replaceState(null, "", "#"), this.router.normalize()) : (i = R(s, ["id"]), t = (e = this.config)
					.loadNavbar, s = e.requestHeaders, o = e.loadSidebar, a = this.router.getFile(l), s = Un(a + i, 0, s), this.isRemoteUrl = p(a), this.isHTML = /\.html$/g.test(a), s.then(function(e, t) {
				...
				if (n) {
					...
					return a ? (a = this.router.getFile(o + a), this.coverIsHTML = /\.html$/g.test(a), ce(a + R(i, ["id"]), !1, r)
						.then(function(e) {
				...
				if (i) {
					...
					return Un(this.router.getFile(e), 0, a)
						.then(function(e, t) {
		...
		return e && (t.__proto__ = e), ((t.prototype = Object.create(e && e.prototype))
				.constructor = t)
			.prototype._renderTo = function(e, t, n) {
				e = d(e);
				...
				! function(e) {
					...
					for (var r, i = 0, o = n.length; i < o; i += 1) {
						var a, s, l = n[i],
							c = l.querySelector("a");
						c && ("/" !== (a = c.getAttribute("href")) && (c = (s = e.parse(a))
							.query.id, s = s.path, c && (a = Re(s, c))), a && (xe[decodeURIComponent(a)] = l))
					}
				...
				}(this.router), n && e && ((n = (t = d("#main"))
					.children[0]) && "H1" !== n.tagName && w(t, v("div", this.compiler.header(e.innerText, 1))
					.children[0]))
				...
				this.callHook("beforeEach", r, function(e) {
					...
					var n;
					a.isHTML ? (n = a.result = r, t(), o()) : Nn({
						compiler: a.compiler,
						raw: e
					}, function(e) {
						n = a.compiler.compile(e), n = a.isRemoteUrl ? ae.sanitize(n, {
							ADD_TAGS: ["script"]
						}) : n, t(), o()
					})
				})
				...
				var n, r = d(".cover");
				S(d("main"), t ? "add" : "remove", "hidden"), e ? (S(r, "add", "show"), (t = (n = this.coverIsHTML ? e : this.compiler.cover(e))
					.trim()
					.match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$')) && ("color" === t[2] ? r.style.background = t[1] + (t[3] || "") : (e = t[1], S(r, "add", "has-mask"), O(t[1]) || (e = N(this.router.getBasePath(), t[1])), r.style.backgroundImage = "url(" + e + ")", r.style.backgroundSize = "cover", r.style.backgroundPosition = "center center"), n = n.replace(t[0], "")), this._renderTo(".cover-main", n), he()) : S(r, "remove", "show")
			}, t.prototype._updateRender = function() {
				var e, t, n, r;
				e = this, t = d(".app-name-link"), n = e.config.nameLink, r = e.route.path, t && (c(e.config.nameLink) ? t.setAttribute("href", n) : "object" == typeof n && (e = Object.keys(n)
					.filter(function(e) {
				...
				l ? (e.repo && (c += (i = e.repo, a = e.cornerExternalLinkTarge, i ? (/\/\//.test(i) || (i = "https://github.com/" + i), '<a href="' + (i = i.replace(/^git\+/, "")) + '" target="' + (a = a || "_blank") + '" class="github-corner" aria-label="View source on Github"><svg viewBox="0 0 250 250" aria-hidden="true"><path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path><path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path><path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path></svg></a>') : "")), e.coverpage && (c += (r = ", 100%, 85%", '<section class="cover show" style="background: ' + ("linear-gradient(to left bottom, hsl(" + Math.floor(255 * Math.random()) + r + ") 0%,hsl(" + Math.floor(255 * Math.random()) + r + ") 100%)") + '"><div class="mask"></div><div class="cover-main">\x3c!--cover--\x3e</div></section>')), e.logo && (r = /^data:image/.test(e.logo), t = /(?:http[s]?:)?\/\//.test(e.logo), n = /^\./.test(e.logo), r || t || n || (e.logo = N(this.router.getBasePath(), e.logo))), c += (n = (t = e)
					.name ? t.name : "", "<main>" + ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + (t.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (t.logo ? '<img alt="' + n + '" src=' + t.logo + ">" : n) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>') + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'), this._renderTo(l, c, !0)) : this.rendered = !0, e.mergeNavbar && h ? u = b(".sidebar") : (s.classList.add("app-nav"), e.repo || s.classList.add("no-badge")), e.loadNavbar && w(u, s), e.themeColor && (f.head.appendChild(v("div", "<style>:root{--theme-color: " + e.themeColor + ";}</style>")
					.firstElementChild), o = e.themeColor, window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)") || (e = k("style:not(.inserted),link"), [].forEach.call(e, function(e) {
